...
${OBJECTDIR}/_ext/1472/Driver.o: ../Driver.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Driver.o ../Driver.cpp

${OBJECTDIR}/_ext/1472/Number.o: ../Number.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Number.o ../Number.cpp

${OBJECTDIR}/_ext/1472/Help.o: ../Help.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Help.o ../Help.cpp

${OBJECTDIR}/_ext/1472/Review.o: ../Review.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Review.o ../Review.cpp

${OBJECTDIR}/_ext/1472/Integer.o: ../Integer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Integer.o ../Integer.cpp

${OBJECTDIR}/_ext/1472/Expression.o: ../Expression.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Expression.o ../Expression.cpp

${OBJECTDIR}/_ext/1472/HelperFunctions.o: ../HelperFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/HelperFunctions.o ../HelperFunctions.cpp

${OBJECTDIR}/_ext/1472/Log.o: ../Log.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Log.o ../Log.cpp

${OBJECTDIR}/_ext/1472/Fraction.o: ../Fraction.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Fraction.o ../Fraction.cpp
